  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#00C2FF]/5 blur-3xl rounded-full" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#F8AF4C]/10 blur-3xl rounded-full" />
      </div>

      <div className="max-w-4xl mx-auto text-center relative z-10">
        {/* Title */}
        <h2 className="text-4xl font-extrabold mb-8 bg-gradient-to-r from-[#00C2FF] to-[#F8AF4C] bg-clip-text text-transparent">
